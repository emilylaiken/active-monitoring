...
class UploadAudioStepComponent extends Component {
  getTopicTexts(topic) {
    if (topic == 'welcome') {
      ...
      return { title: 'Identify message', description: 'Ask the caller your identifier' }
    } else if (topic == 'registration') {
      return { title: 'Registration message', description: 'Inform the caller about the registration process' }
